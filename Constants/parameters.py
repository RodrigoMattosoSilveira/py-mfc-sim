...
# Pick parameters
TIME_TO_WALK_TO_PICK_STATION_MIN =  20
TIME_TO_WALK_TO_PICK_STATION_MAX = 30
TIME_TO_WALK_TO_PICK_NEXT_ITEM_MIN = 5
TIME_TO_WALK_TO_PICK_NEXT_ITEM_MAX = 10
KIT_ITEMS_PER_PICK = 2
TIME_TO_PICK_ITEM_MIN = 5
TIME_TO_PICK_ITEM_MAX = 15
RANDOM_SKU_QTD_A = 4
INVENTORY_AVAILABILITY_PROBABILITY = 95
TIME_TO_WALK_TO_OUTBOUND_SHELF_AREA_MIN = 20
TIME_TO_WALK_TO_OUTBOUND_SHELF_AREA_MAX = 30
TIME_TO_PLACE_ITEM_IN_CONTAINER_MIN = 10
TIME_TO_PLACE_ITEM_IN_CONTAINER_MAX = 15
TIME_TO_PLACE_CONTAINER_ON_OUTBOUND_SHELF_MIN = 25
TIME_TO_PLACE_CONTAINER_ON_OUTBOUND_SHELF_MAX = 30
